...
| Package | Patch | What |
|---------|-------|------|
| `openclaw@2026.4.27` | `patches/openclaw@2026.4.27.patch` | Mattermost websocket ping/pong keepalive with pong-timeout reconnect |
...
- `openclaw` binary comes from npm (`openclaw@2026.4.27`), not built from source
