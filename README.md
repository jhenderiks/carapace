...
All rewrite logic now lives in the RTK binary itself, so Carapace picks up new RTK rules by upgrading RTK rather than carrying its own TypeScript routing table.
