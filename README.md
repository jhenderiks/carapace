...
|---|---|---|---|
| `openclaw@2026.4.27` | `patches/openclaw@2026.4.27.patch` | Mattermost websocket can go stale silently; adds ping/pong keepalive with timeout-based reconnect | [#44160](https://github.com/openclaw/openclaw/issues/44160) |
