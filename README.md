...
|---|---|---|---|
| `openclaw@2026.4.5` | `patches/openclaw@2026.4.5.patch` | Mattermost websocket can go stale silently — adds ping/pong keepalive with timeout-based terminate/reconnect | [#44160](https://github.com/openclaw/openclaw/issues/44160) |
